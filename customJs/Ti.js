function generateDateViewElements() {
    ...
    const elements = [
        ...
        dv.el('progress', null, { attr: { max: 7, value: weekDiff, percentage: weekPercentage } }),
...
const dateViewElements = generateDateViewElements();
dateViewElements;
